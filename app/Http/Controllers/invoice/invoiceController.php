...
class invoiceController extends Controller
{
    public function addInvoice()
    {
        ...
        $allinvoice = invoice::with('customerName')->orderBy('id', 'desc')->get();
    ...
    public function storeInvoice(Request $request)
    {
        ...
        return redirect()->route('invoice_approve_list')->with($notification);
    }
    ...
    public function invoiceCancaled($id)
    {
        ...
        $notification = ['messege' => 'Invoice Deleted Successfully', 'alert-type' => 'success'];
        return redirect()->back()->with($notification);
    }
    ...
    public function storeConsumption(Request $request)
    {
        ...
        if ($request->quantity == null) {
            $notification = [
                'message'    => 'You Must Fill Quantity Field!',
                'alert-type' => 'error'
            ];
            return redirect()->back()->with($notification);
        }
