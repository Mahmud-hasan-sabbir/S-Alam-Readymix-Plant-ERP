...
class AccountController extends Controller
{
    ...
    public function storePaymentSupplier(Request $request)
    {
        ...
        return redirect()->route('supplier_payment_approve_list')->with($notification);
    }
    ...
    public function supplierPaymentApprove($id)
    {
        ...
        return redirect()->route('suppler_payment')->with($notification);
    }
    ...
    public function storePaymentCustomer(Request $request)
    {
        ...
        // return redirect()->back()->with($notification);
        return redirect()->route('coustomer_payment_approve_list')->with($notification);
    }
    ...
    public function coustomerPaymentApprove($id)
    {
        ...
        $notification = ['messege' => 'Payment Approve Successfully', 'alert-type' => 'success'];
        return redirect()->route('coustomer_payment')->with($notification);
    }
    ...
    public function storeCoExpense(Request $request)
    {
        ...
        // return redirect()->back()->with($notification);
        return redirect()->route('expense_approve_list')->with($notification);
    ...
    public function expensePaymentApprove($id)
    {
        ...
        return redirect()->route('com_expense')->with($notification);
    }
    ...
    public function storeRefunding(Request $request)
    {
        ...
        return redirect()->route('refunding_approve_list')->with($notification);
    ...
    public function updateRefunData(Request $request)
    {
        ...
        return redirect()->route('refunding_payment')->with($notification);
    }
