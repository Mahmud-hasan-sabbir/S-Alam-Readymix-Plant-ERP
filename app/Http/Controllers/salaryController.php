...
class salaryController extends Controller
{
    ...
    public function storeAdvancedSalary(Request $request)
    {
        ...
        return redirect()->route('advanced_approve_salary_list')->with($notification);
    ...
    public function adSalaryApprove($id)
    {
        ...
        $notification = ['messege' => 'Advance Salary Approve Successfully', 'alert-type' => 'success'];
        return redirect()->route('advanced_salary')->with($notification);
    }

    public function adSalaryCancaled($id)
    {
        advancedSalary::where('id', $id)->delete();
        $notification = ['messege' => 'Advance Salary Delete Successfully', 'alert-type' => 'success'];
        return redirect()->back()->with($notification);
    }
