        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">Create Investment Or Loan</h5>
                ...
                <form class="form-valide" action="{{ route('store_investloan') }}" method="POST" enctype="multipart/form-data" id="advancedsalaryform">
                    ...
                    <div class="modal-body py-2 px-4">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="date" id="start_date" required class="form-control" name="start_date" value="{{ old('date') ? old('date'):  date('Y-m-d') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="date" id="end_date" required class="form-control" name="end_date" value="{{ old('date') ? old('date'):  date('Y-m-d') }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label class="form-label" for="per_number"> Notes :</label>
