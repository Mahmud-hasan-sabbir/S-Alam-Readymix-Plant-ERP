        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title">Customer Payment Receivable</h4>
                ...
                <form class="form-valide" action="{{ route('store_payment_customer') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-2 px-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4">Customer Name</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="pay_reason" id="" class="form-control">
                                            <option value=" Materials Sale">RMC Sale</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group row">
                                <label for="" class="col-md-4"> Pay Mode</label>
                                <div class="col-md-8">
                                  <select name="pay_mode" id="paymentMode" class="form-control dropdwon_select" onchange="toggleFields()">
                          ...
                          <div class="row" >
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4"> Pay Date</label>
                                    <div class="col-md-8">
                          ...
                          <div class="row" id="checkDateRow" style="display: none">
                            <div class="col-md-12">
                              <div class="form-group row">
                                <label for="" class="col-md-4">Check Issue Date</label>
                                <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4"> Payment Amount</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4"> Notes:</label>
                                    <div class="col-md-8">
