                                ...
                                <div class="form-validation">
                                    ...
                                    <form action="{{ route('store_opening_balance') }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left" >
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                               <select name="account_type" class="form-control dropdwon_select" id="accountType">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                <select name="opening_type" class="form-control dropdwon_select">
                                                    <option value="">Select Method</option>
                                                    <option value="Debit">Debit (Deposit)</option>
                                                    <option value="Credit">Credit (Withdraw)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <label for="" class="col-md-4 ">Add Money</label>
                                            <div class="col-md-8">
                                                <input type="text" name="opening_balance" class="form-control" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
