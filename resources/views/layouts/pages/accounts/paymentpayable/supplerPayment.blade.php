        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title">Payment for supplier</h4>
                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr style="{{ $data->is_approve == 0 ? 'background-color: #D1D119 !important; color: #fff' : '' }}">
                                    ...
                                    <td>
                                        @if($data->is_approve == 0)
                                            <button type="button" class="btn btn-primary light edit" id="Edit" data-id="{{ $data->id }}">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        @endif

                                        <button type="button" class="btn btn-success light view" id="view" data-id="{{ $data->id }}">
                ...
                <form class="form-valide" action="{{ route('store_payment_supplier') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                  <select name="pay_mode" id="paymentMode" required class="form-control dropdwon_select" onchange="toggleFields()">
                        ...
                        <div class="row" id="bankNameRow" style="display: none">
                            <div class="col-md-12">
                              <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <select name="bank_name"  id="bankName" class="form-control dropdwon_select">
                          ...
                          <div class="row" id="checkDateRow" style="display: none">
                            <div class="col-md-12">
                              <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                  <input type="date" value="{{ now()->format('Y-m-d') }}" name="check_date" id="checkDate" class="form-control">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-5"> Notes</label>
                                    <div class="col-md-7">
