        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title">Expense Head</h4>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">Create Expense Head</h5>
                ...
                <form class="form-valide" action="{{ route('store_expense_head') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-2 px-4">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label for="name" class="form-label">Head Name : <span class="text-danger">*</span> </label>
                        ...
                        <div class="row mt-2">                            
                            <div class="col-md-12">
                                ...
                                <textarea name="description" id="description" class="form-control" placeholder="Notes"></textarea>
                             </div>
                        </div>
