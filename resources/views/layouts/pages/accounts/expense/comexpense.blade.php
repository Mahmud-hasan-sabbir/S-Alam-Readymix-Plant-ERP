                        ...
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->pay_mode }}</td>
                                    <td class="text-right">{{ (number_format($data->pay_amount)) }}</td>
                                    <td>
                    ...
                    <div class="modal-body py-2 px-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="pay_reason" required id="" class="form-control">
                                            <!-- <option value="" @selected(true) @disabled(true)>Select Payment Reason</option> -->
                        ...
                        <div class="row">
                          ...
                          <div class="row" id="cashaccountidrow" style="display: none">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4">Cash Total Amount</label>
                                    <div class="col-md-8">
                          ...
                          <div class="row" id="bankaccountidrow" style="display: none">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="" class="col-md-4">Bank Total Amount</label>
                                    <div class="col-md-8">
                          ...
                          <div class="row" id="checkDateRow" style="display: none">
                            <div class="col-md-12">
                              <div class="form-group row">
                                <label for="" class="col-md-4"> Check issu Date</label>
                                <div class="col-md-8">
