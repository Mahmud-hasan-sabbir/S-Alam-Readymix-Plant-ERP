        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <table id="audit-design-matrix-table" class="table table-bordered">
                    ...
                    <tr>
                        <th width="32%" style="text-transform: capitalize">Trans Name</th>
                        <th width="19%" style="text-transform: capitalize">Amount</th>
                        <th width="19%" style="text-transform: capitalize">Debit (Deposit)</th>
                        <th width="19%" style="text-transform: capitalize">Credit (Withdraw)</th>
                        <th width="11%" style="text-transform: capitalize">Action
                    ...
                    <tbody>
                        <tr class="audit_design_matrix_row addr" >
                            ...
                            <td style="border: 0px">
                                <select name="data[1][trans_name]" style="border-radius: 30px" id="accountId" class="form-control dropdwon_select " required>
