                            ...
                            <tbody>
                                @foreach ($adsalary as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">{{ $item->employee->company_name }}</td>
                                        <td>{{ $item->employee->desig->name }}</td>
                                        <td>{{ number_format($item->employee->salary) }}</td>
                                        <td>{{ number_format($item->advanced_salary) }}</td>
                                        <td>{{ $item->month }}</td>
                                        <!-- <td>{{ $item->pay_mode }}</td> -->
                                        <td>
                                            @if($item->status == 1)
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">Create Advanced Salary</h5>
                ...
                <form class="form-valide" action="{{ route('store_advanced_salary') }}" method="POST" enctype="multipart/form-data" id="advancedsalaryform">
                    ...
                    <div class="modal-body py-2 px-4">
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="emp_namee"> Employee Name: </label>
                                    <div class="col-md-8">
                                        <select name="emp_id" id="employeeName" required class="form-control dropdwon_select">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label">Current Salary : </label>
                                    <div class="col-md-8">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="designation"> Designation: </label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number"> Year</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="designation"> Month: </label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6" id="padd">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number">Advance Salary :</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number"> Pay Mode :</label>
                                    <div class="col-md-8">
                                        <select name="pay_mode" required id="pay_mode" class="form-control dropdwon_select">
                                            <option value="" selected disabled>Select Pay Mode</option>
                            ...
                            <div class="col-md-6 cash-field" style="display: none">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="cash_total_amount"> Total Cash Amount :</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6 bank-field" style="display: none">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="bank_name" id="bank_name" class="form-control dropdwon_select">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6 bankacc_no" style="display: none">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number">Account Number:</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6 banktotalfield" style="display: none">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number"> Bank Total Amount :</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label">Advanced Salary : </label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-4 col-form-label" for="per_number"> Date :</label>
                                    <div class="col-md-8">
