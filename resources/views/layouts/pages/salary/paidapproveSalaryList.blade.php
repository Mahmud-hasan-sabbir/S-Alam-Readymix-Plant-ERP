        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title">paid Salary Approve List</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <form action="{{ route('paid_salary_approve',['id' => $item->id]) }}" method="post" >
                                                <button class="btn btn-sm btn-success">Approve</i></button>
                                                @csrf
                                                @method('PATCH')
                                            </form>
                                            ...
                                            <button class="btn btn-sm btn-info view"  data-id="{{ $item->id }}" >view</i></button>
