                            ...
                            <tbody>
                                @foreach ($paidsalary as $item)
                                    <tr>
                                        ...
                                        <td>{{ number_format($item->adv_salary) }}</td>
                                        <td>{{ number_format($item->paid_salary) }}</td>
                                        <td>{{ $item->month }}</td>
                                        <td>
                                            @if($item->status == 1)
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">Create Paid Salary</h5>
                    ...
                    <div class="modal-body py-2 px-4">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6 cash-field" style="display: none">
                                <div class="row">
                                    <label class="col-md-5 col-form-label" for="cash_total_amount"> Total Cash Amount :</label>
                                    <div class="col-md-7">
                                        <input type="number"  class="form-control" readonly id="cashtotalamount" name="" placeholder="Total Cash Amount">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6 bankacc_no" style="display: none">
                                <div class="row">
                                    <label class="col-md-5 col-form-label" for="per_number">Account Number</label>
                                    <div class="col-md-7">
