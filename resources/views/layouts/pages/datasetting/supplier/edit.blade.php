        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    ...
                    <a href="{{ route('information.index', ['cat_id' => 1]) }}" class="btn btn-sm btn-success"><i class="fa fa-reply"></i><span class="btn-icon-add"></span>Back</a>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $supplierEdit->company_name }}" placeholder="Company Name" name="com_name" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $supplierEdit->contact_person }}" placeholder="Contact Person" name="contact_name" class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="input form-control" value="{{ $supplierEdit->mobile_no }}"  placeholder=" Mobile Number" type="tel" name="mobile_no"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="{{ $supplierEdit->Email }}" placeholder=" Email" name="email" class="form-control" >
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">Security Cheque</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">Bank Guaranty</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <textarea name="address" class="form-control">{{ $supplierEdit->Address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="note" class="form-control">{{ $supplierEdit->note }}</textarea>
                                    </div>
                                </div>
