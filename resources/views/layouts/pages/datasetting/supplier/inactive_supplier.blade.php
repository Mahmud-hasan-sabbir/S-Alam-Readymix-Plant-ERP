        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title">Inactive Supplier</h4>
                        ...
                        <table id="example3" class="display table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge light badge-primary">
                                        {{ $item->Status }}
                                    </span></td>

                                    <td>
                                        <a href="{{ route('supplier_edit', $item->id) }}" class="btn btn-primary light">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <a href="{{ route('supplier_view', $item->id) }}" class="btn btn-success light">
