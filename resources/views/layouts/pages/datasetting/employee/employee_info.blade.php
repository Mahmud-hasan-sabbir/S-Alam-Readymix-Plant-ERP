                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="email" id="email" placeholder="Email" aria-invalid aria-required="true"   name="email" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input class="input form-control"  placeholder="Mobile Number" id="personnalNumber" type="tel" name="personalNumber" placeholder="" autocomplete="off"  aria-labelledby="InputLabel" aria-invalid aria-required="true"  tabindex="1" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select name="employeeDesignation" id="" required class="form-control dropdwon_select">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                       <select name="gender" aria-invalid aria-required="true"  id="gender" class="form-control dropdwon_select">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select name="employeeStatus" id=""  class="form-control dropdwon_select">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" placeholder="Salary" required class="form-control" name="salary">
                                    </div>
                                </div>
