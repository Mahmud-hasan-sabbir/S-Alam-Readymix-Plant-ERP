...
@foreach ($getadsalaryreport as $item )
<tr>
    ...
    <td scope="col">{{ $item->advanced_salary}}</td>
...
<script>
    var totaladvanced = {{ $totaladvanced }};
    document.getElementById('debitSumDisplay').innerHTML = totaladvanced;
</script>
