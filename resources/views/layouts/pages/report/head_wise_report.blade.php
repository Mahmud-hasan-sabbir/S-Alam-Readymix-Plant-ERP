            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-5">
                                <div class="row">
                                    <label class="col-md-4 col-form-label font-weight-bold">Head Name</label>
                                    <div class="col-md-8">

                                        <select name="headName" id="headid" class="form-control dropdwon_select head" style="margin-left: -20px">
                                            <option value="" selected disabled>select a head name</option>
                                            @foreach ($allhead as $item )
...
<script>
     $(document).on('click','#filter',function(){
        ...
        var headCode = $('#headid').val();
            $.ajax({
                url:'{{ route('get_head_wise_report') }}',
                method:'GET',
                dataType:"html",
