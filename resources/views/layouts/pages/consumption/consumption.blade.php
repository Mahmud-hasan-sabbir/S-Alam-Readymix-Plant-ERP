                        ...
                        <table id="example3" class="display table table-hover">
                            ...
                            <tbody id="purchase_tbody">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">{{ $row->customerName->company_name }}</td>
                                    <td>{{ $row->inv_no }}</td>
                                    <td>{{ $row->date }}</td>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button type="button" class="btn btn-danger light">Pending</button>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('consum_add',$row->id) }}" class="btn btn-secondary light">
