                ...
                <div class="modal-body py-2">
                    <div class="row" id="main-row-data">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" readonly id="orderNOeeee" name="po_no" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Materials Name :<span class="text-danger">*</span></label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered" id="productTableedit">
...
function calculateSubtotalAndTotal() {
    ...
    $('#productTableedit tbody tr').each(function() {
        ...
        if (productName === 'Bricks') {
            // For Bricks, use quantity * price formula
            subtotal = (quantity * unitPrice) - truckFee;
        } else {
            // For other materials, use tons formula
            var qtyInTons = quantity / 1000; // Convert quantity to tons
            subtotal = (qtyInTons * unitPrice) - truckFee;
        }
