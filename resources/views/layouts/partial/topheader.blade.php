        ...
        ***********************************-->
        <div class="nav-header">
			<a href="{{url('/')}}" class="brand-logo">
				...
				<span class="brand-title" width="" height="">
					<img src="{{ asset('/public/images/logo.png') }}"  height="40" style="margin-bottom: -1px" alt="">
				</span>
            </a>
			{{-- <a href="{{url('/')}}" class="brand-logo">
				<span class="logo-abbr" width="30" height="50">
        ...
        ***********************************-->
        <div class="header">
            ...
            <div style="display:flex;margin-top: 0px; margin-left:-232px;width:121%">
                <div style="width:33%;border-bottom:4px solid #000000;"></div>
                <div style="width:34%;border-bottom:4px solid #f04e23;"></div>
                <div style="width:33%;border-bottom:4px solid #05f82d;"></div>
