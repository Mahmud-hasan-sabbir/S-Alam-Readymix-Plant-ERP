            ...
            <div class="auth-form">
                ...
                <div class="text-center mb-3">
                    <div style="margin-left: -20px;margin-right: -20px;">
                        <a href="{{url('/')}}"><img src="{{asset('public/images')}}/logo.png" style="width:75%; height:84px; margin-top:-39px" alt=""></a>
                    </div>
                </div><br>
                <h4 class="text-center mb-4" style="margin-top:-27px">Sign in your account</h4>
                <form method="POST" action="{{ route('register') }}" style="margin-top:-17px">
                    @csrf
                    ...
                    <div class="form-group" style="margin-top:-11px">
                        ...
                        <input type="number" name="email" id="email" placeholder="Email or Phone" class="form-control" :value="old('email')" required autofocus>
                    </div>
                    <div class="form-group" style="margin-top:-11px">
                    ...
                    <div class="form-group" style="margin-top:-11px">
                        ...
                        <div style="position: relative;">
                            <input type="password" name="confirm_password" id="password" class="form-control pass-key" placeholder="Password" required autocomplete="current-password">
                            <span style="position: absolute;right: 10px;top: 10px;cursor: pointer;" class="show_password">SHOW</span>
                        </div>
                    </div>
